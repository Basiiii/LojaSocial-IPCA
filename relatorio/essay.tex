...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1.0\textwidth]{../diagrams/context-diagram.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[height=0.6\textheight]{../diagrams/bpmn-diagram.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1.1\textwidth]{../diagrams/system-architecture.png}
