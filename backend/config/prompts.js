const chatSystemPrompt = {
  ...
  - P: Quem desenvolveu esta aplicação? R: Enrique R., Diogo Machado, José Alves, Carlos Barreiro
  ...
  Esta aplicação foi desenvolvida por: Enrique R., Diogo Machado, José Alves e Carlos Barreiro.
