...
\newline\textbf{Participantes}: Carlos Barreiro, Diogo Machado, Enrique Rodrigues, José Alves,  \textbf{Dra. Juliana Araújo(FASA)}
...
\subsubsection*{1 - \textit{Workshop} sobre Gestão de Conflitos com Dra. Juliana Araújo}
...
\textbf{Local}: IPCA – Escola Superior de Tecnologia - Laboratório de Redes
\newline\textbf{Hora}: 14h00
\newline\textbf{Data}: 3 de Novembro de 2025
\newline\textbf{Participantes}: Carlos Barreiro, Diogo Machado, Enrique Rodrigues, José Alves
...
Necessidade de rever os requisitos e funcionalidades da entrega anterior, para ir de encontro aos novos requisitos propostos. São eles:
\begin{itemize}
	\item login/registo/recuperação de acessos
	\item perfil de beneficiário
	\item candidatura
...
\subsection*{2 - Atribuição das novas tarefas}
\begin{itemize}
	\item Revisão do relatório anterior - Enrique
	\item Revisão do diagrama BPMN - Diogo
	\item Diagrama de Estados - José
	\item Diagrama de Casos de Uso - Carlos
	\item Diagrama de Domínio - Enrique
	\item Organização do Relatório - Diogo
	\item Dossier de Organização de Grupo - José
\end{itemize}
...
\section{Reunião 7 Novembro 2025}

\subsection*{Contexto}
\textbf{Local}: Via Zoom
\newline\textbf{Hora}: 14h00
\newline\textbf{Data}: 7 de Novembro de 2025
\newline\textbf{Participantes}: Carlos Barreiro, Diogo Machado, Enrique Rodrigues, José Alves

\subsection*{Ordem de Trabalhos}
\begin{itemize}
	\item 1 - Revisão das alterações	
\end{itemize}

\subsection*{Desenvolvimento}

\subsubsection*{1 - Revisão das alterações}

Tarefas Realizadas/A realizar:
\begin{itemize}
	\item Revisão do relatório anterior - Quase concluida
	\item Revisão do diagrama BPMN - Concluido
	\item Diagrama de Estados - Concluido
	\item Diagrama de Casos de Uso - Em progresso
	\item Diagrama de Domínio - Em progresso
	\item Organização do Relatório - Em progresso
	\item Dossier de Organização de Grupo - Em progresso
\end{itemize}

\subsection*{Deliberação e próximos passos}
\begin{itemize}
	\item Continuar a revisão do relatório
	\item Continuar o Diagrama de Casos de Uso
	\item Continuar o Diagrama de Domínio
	\item Contiuar a organização do Relatório, implementando as novas alterações.
\end{itemize}
...
\section{Reunião 10 Novembro 2025}

\subsection*{Contexto}
\textbf{Local}: IPCA – Escola Superior de Tecnologia - Laboratório de Redes
\newline\textbf{Hora}: 11h00
\newline\textbf{Data}: 10 de Novembro de 2025
\newline\textbf{Participantes}: Carlos Barreiro, Diogo Machado, Enrique Rodrigues, José Alves

\subsection*{Ordem de Trabalhos}
\begin{itemize}
	\item 1 - Ponto de Situação	
\end{itemize}

\subsection*{Desenvolvimento}

\subsubsection*{1 - Ponto de Situação}

Tarefas Realizadas/A realizar:
\begin{itemize}
	\item Revisão do relatório anterior - Em Conclusão
	\item Diagrama de Casos de Uso - Em progresso
	\item Diagrama de Domínio - Primeira Proposta
	\item Organização do Relatório - 1ª fase concluida
	\item Dossier de Organização de Grupo - Em progresso
\end{itemize}

\subsection*{Deliberação e próximos passos}
\begin{itemize}
	\item Concluir a revisão do relatório
	\item Continuar o Diagrama de Casos de Uso
	\item Continuar o Diagrama de Domínio
	\item Concluir a organização do Relatório, implementando as novas alterações.
\end{itemize}
...
\section{Reunião 14 Novembro 2025}

\subsection*{Contexto}
\textbf{Local}: IPCA – Escola Superior de Tecnologia - Laboratório de Redes
\newline\textbf{Hora}: 14h00
\newline\textbf{Data}: 14 de Novembro de 2025
\newline\textbf{Participantes}: Carlos Barreiro, Diogo Machado, Enrique Rodrigues, José Alves
...
Tarefas Realizadas/A realizar:
\begin{itemize}
	\item Revisão do relatório anterior - Concluido
	\item Diagrama de Casos de Uso - Em progresso
	\item Diagrama de Domínio - Proposta Corrigida
	\item Organização do Relatório - 2ª fase concluida
	\item Dossier de Organização de Grupo - Em progresso
\end{itemize}
...
\begin{itemize}
	...
	\item Continuar o Diagrama de Casos de Uso
	\item Continuar o Diagrama de Domínio
	\item Concluir a organização do Relatório
\end{itemize}

\subsection*{Encerramento}
\textbf{Encerramento da reunião:} 15h30
\newline \textbf{Elaborada por:} José Alves
\newline \textbf{Aprovada por:} Enrique Rodrigues

\newpage
\section{Reunião 17 Novembro 2025}

\subsection*{Contexto}
\textbf{Local}: IPCA – Escola Superior de Tecnologia - Laboratório de Redes
\newline\textbf{Hora}: 11h00
\newline\textbf{Data}: 17 de Novembro de 2025
\newline\textbf{Participantes}: Carlos Barreiro, Diogo Machado, Enrique Rodrigues, José Alves
...
\section{Reunião 21 Novembro 2025}

\subsection*{Contexto}
\textbf{Local}: IPCA – Escola Superior de Tecnologia - Laboratório de Redes
\newline\textbf{Hora}: 14h00
\newline\textbf{Data}: 21 de Novembro de 2025
\newline\textbf{Participantes}: Carlos Barreiro, Diogo Machado, Enrique Rodrigues, José Alves
...
Tarefas Realizadas/A realizar:
\begin{itemize}
	\item Diagrama de Estados - Processo de Candidatura a apoio Concluido
	\item Dossier de Organização de Grupo - Em progresso
\end{itemize}

\subsection*{Deliberação e próximos passos}
\begin{itemize}
	\item Concluir o Diagrama de Casos de Uso
	\item Continuar o Diagrama de Domínio
	\item Concluir a organização do Relatório
\end{itemize}

\subsection*{Encerramento}
\textbf{Encerramento da reunião:} 15h45
\newline \textbf{Elaborada por:} José Alves
\newline \textbf{Aprovada por:} Enrique Rodrigues

\newpage

\section{Reunião 24 Novembro 2025}

\subsection*{Contexto}
\textbf{Local}: IPCA – Escola Superior de Tecnologia - Laboratório de Redes
\newline\textbf{Hora}: 11h00
\newline\textbf{Data}: 24 de Novembro de 2025
\newline\textbf{Participantes}: Carlos Barreiro, Diogo Machado, Enrique Rodrigues, José Alves, Joana Costa e Mafalda Cardoso (\textbf{GPIPSA})

\subsection*{Ordem de Trabalhos}
\begin{itemize}
	\item 1 - Workshop Sobre Gestão de Tempo
\end{itemize}

\subsection*{Desenvolvimento}

\subsubsection*{1 - Workshop Sobre Gestão de Tempo}

Estratégias para melhor Gestão de Tempo:
\begin{itemize}
	\item Matriz de Eisenhower
	\item Método Getting Things Done
	\item Time Blocking
	\item Eat that Frog
\end{itemize}

Algumas aplicações para GEstão de Tempo:
\begin{itemize}
	\item Trello
	\item Todoist
	\item Clockify
...
\subsection*{Deliberação e próximos passos}
\begin{itemize}
	\item Conclusão do Diagrama de Casos de Uso
	\item Aprovar o Diagrama de Domínio
	\item Concluir a organização do Relatório
\end{itemize}
...
\section{Reunião 28 Novembro 2025}

\subsection*{Contexto}
\textbf{Local}: IPCA – Escola Superior de Tecnologia - Laboratório de Redes
\newline\textbf{Hora}: 14h00
\newline\textbf{Data}: 28 de Novembro de 2025
\newline\textbf{Participantes}: Carlos Barreiro, Diogo Machado, Enrique Rodrigues, José Alves

\subsection*{Ordem de Trabalhos}
\begin{itemize}
	\item 1 - Validação e entrega dos documentos da segunda sprint.
	\item 2 - Elaboração de mais \textit{mockups}.
\end{itemize}

\subsection*{Desenvolvimento}

\subsubsection*{1 - Validação e entrega dos documentos da segunda sprint}

Todos os elementos foram validados com sucesso, tendo sido entregues na plataforma moodle às 15h16.

\subsection*{Deliberação e próximos passos}

\subsubsection*{Elaboração de mais \textit{mockups}}
\begin{itemize}
	\item Página de Login
	\item Página de Scan de Código de Barras
	\item Página de Pedido Pendente
\end{itemize}
...
\section{Reunião 5 Dezembro 2025}

\subsection*{Contexto}
\textbf{Local}: IPCA – Escola Superior de Tecnologia - Laboratório de Redes
\newline\textbf{Hora}: 14h00
\newline\textbf{Data}: 5 de Dezembro de 2025
\newline\textbf{Participantes}: Carlos Barreiro, Diogo Machado, Enrique Rodrigues, José Alves, Dra. Carla (\textbf{SASIPCA})

\subsection*{Ordem de Trabalhos}
\begin{itemize}
	\item 1 - Apresentação do fluxo atual da aplicação ao Cliente.
\end{itemize}

\subsection*{Desenvolvimento}

\subsubsection*{1 - Apresentação do fluxo atual da aplicação ao Cliente}

O fluxo pensado atualmente para a aplicação foi mostrado, através de um protótipo no \textit{Figma}, ao cliente, na pessoa da Dra. Carla. O \textit{feedback} em relação ao \textit{design} de UI e ao fluxo de trabalho foi \textbf{bastante positivo}.

\subsection*{Deliberação e próximos passos}
\subsubsection*{Desenvolvimento do código correspondente às páginas nos \textit{mockups}.}
\begin{itemize}
	\item Página de Login
	\item Página de Scan de Código de Barras
	\item Página de Pedido Pendente
	\item Dashboard de Funcionário
	\item Dashboard de Beneficiário
	\item ...
\end{itemize}

\subsection*{Encerramento}
\textbf{Encerramento da reunião:} 15h55
\newline \textbf{Elaborada por:} José Alves
\newline \textbf{Aprovada por:} Enrique Rodrigues

\newpage

\section{Reunião 12 Dezembro 2025}

\subsection*{Contexto}
\textbf{Local}: IPCA – Escola Superior de Tecnologia - Laboratório de Redes
\newline\textbf{Hora}: 14h00
\newline\textbf{Data}: 12 de Dezembro de 2025
\newline\textbf{Participantes}: Carlos Barreiro, Diogo Machado, Enrique Rodrigues

\subsection*{Ordem de Trabalhos}
\begin{itemize}
	\item 1 - Atribuição de tarefas na plataforma \textbf{Linear}.
	\item 2 - Continuação dos \textit{mockups}.
\end{itemize}

\subsection*{Desenvolvimento}

\subsubsection*{1 - Atribuição de tarefas na plataforma \textbf{Linear}}

Começamos a utilizar uma aplicação para gestão de tempo e tarefas, chamada Linear, em \href{https://linear.app/projeto-lojasocial/team/PRO/active}{linear.app}, começando a atribuir mais tarefas de código a cada elemento. Esta é a plataforma que será usada para gestão do trabalho.

\subsubsection*{2 - Continuação dos \textit{mockups}}
Foram desenvolvidos mais alguns mockups.

\subsection*{Deliberação e próximos passos}

Continuação do desenvolvimento do código correspondente às páginas nos \textit{mockups}.

\subsection*{Encerramento}
\textbf{Encerramento da reunião:} 15h40
\newline \textbf{Elaborada por:} Diogo Machado
\newline \textbf{Aprovada por:} Enrique Rodrigues

\newpage

\section{Reunião 15 Dezembro 2025}

\subsection*{Contexto}
\textbf{Local}: IPCA – Escola Superior de Tecnologia - Laboratório de Redes
\newline\textbf{Hora}: 11h00
\newline\textbf{Data}: 15 de Dezembro de 2025
\newline\textbf{Participantes}: Carlos Barreiro, Diogo Machado, Enrique Rodrigues, José Alves

\subsection*{Ordem de Trabalhos}
\begin{itemize}
	\item 1 - Continuação dos \textit{mockups}.
	\item 2 - Elaboração de Diagramas de Sequência em falta para a Entrega 3.
\end{itemize}

\subsection*{Desenvolvimento}

\subsubsection*{1 - Continuação dos \textit{mockups}}
Foram desenvolvidos mais alguns mockups que estavam em falta.

\subsubsection*{2 - Elaboração de Diagramas de Sequência em falta para a Entrega 3}
Início do desenvolvimento dos diagramas de sequência necessários. Serão feitos os diagramas de aceitar candidatura, adicionar item ao stock e submeter candidatura.

\subsection*{Deliberação e próximos passos}

\begin{itemize}
	\item Continuação do desenvolvimento do código correspondente às páginas nos \textit{mockups}.
	\item Terminar Diagramas de Sequência
\end{itemize}
...
\section{Reunião 19 Dezembro 2025}

\subsection*{Contexto}
\textbf{Local}: IPCA – Escola Superior de Tecnologia - Laboratório de Redes
\newline\textbf{Hora}: 14h00
\newline\textbf{Data}: 19 de Dezembro de 2025
\newline\textbf{Participantes}: Carlos Barreiro, Diogo Machado, Enrique Rodrigues

\subsection*{Ordem de Trabalhos}
\begin{itemize}
	\item 1 - Preparação da Entrega 3.
	\item 2 - Validação dos documentos a entregar.
\end{itemize}

\subsection*{Desenvolvimento}

\subsubsection*{1 - Preparação da Entrega 3}
Preparação dos documentos em falta para concluir a Entrega 3

\subsubsection*{2 - Validação dos documentos a entregar}
Validação dos documentos a entregar, garantindo que estão concluídos os seguintes itens:

\begin{itemize}
	\item Diagrama de Sequência de Adicionar Produto ao Stock e Chat Suporte
	\item Vários Mockups
	\item Revalidação do dossier de Organização de Grupo
	\item Implementação atual da app (Código)
\end{itemize}

\subsection*{Deliberação e próximos passos}

\begin{itemize}
	\item Continuação do desenvolvimento do código da aplicação.
\end{itemize}
...
\section{Reunião 5 Janeiro 2026}

\subsection*{Contexto}
\textbf{Local}: IPCA – Escola Superior de Tecnologia - Laboratório de Redes
\newline\textbf{Hora}: 11h00
\newline\textbf{Data}: 5 de Janeiro de 2026
\newline\textbf{Participantes}: Carlos Barreiro, Diogo Machado, Enrique Rodrigues, José Alves

\subsection*{Ordem de Trabalhos}
\begin{itemize}
	\item 1 - Ponto de Situação
	\item 2 - Implementação de novas funcionalidades
\end{itemize}
...
\begin{itemize}
	\item Login
	\item Portais Funcionário/Beneficiário
	\item Adicionar Stock
	\item UI para Suporte, Pedidos de Levantamento, Submeter Candidatura, Candidaturas
	\item User Metadata
	\item Navegação por roles
	\item NavBar funcional
\end{itemize}

\subsubsection*{2 - Implementação de novas funcionalidades}
Implementamos:

\begin{itemize}
	\item Sistema de notificação de validades
	\item Pedidos de Levantamento
	\item Gestão de Candidaturas
\end{itemize}
...
\section{Reunião 9 Janeiro 2026}

\subsection*{Contexto}
\textbf{Local}: IPCA – Escola Superior de Tecnologia - Laboratório de Redes
\newline\textbf{Hora}: 14h00
\newline\textbf{Data}: 9 de Janeiro de 2026
\newline\textbf{Participantes}: Carlos Barreiro, Diogo Machado, Enrique Rodrigues, José Alves

\subsection*{Ordem de Trabalhos}
\begin{itemize}
	\item 1 - Implementação de novas funcionalidades
\end{itemize}

\subsection*{Desenvolvimento}

\subsubsection*{1 - Implementação de novas funcionalidades}
Implementamos:

\begin{itemize}
	\item Gestão de Stocks
	\item Gestão de Beneficiários
	\item Adicionar Imagens aos produtos
	\item Gestão de Campanhas
\end{itemize}
